 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbName = 'mdt'; // database name
        $this->dbUser = 'root'; // database user name
        $this->dbPwd = 'root'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://local.mdt'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/var/www/shared/superreal/oxid-demo';
        $this->sCompileDir = '/var/www/shared/superreal/oxid-demo/tmp';
